...
{
    /// <summary>
    /// Представляет Лабораторную работу 1, включающую задачи на:
    /// 1. Вычисление выражений с использованием унарных операторов.
    /// 2. Проверку принадлежности точки заданной области.
    /// 3. Вычисление выражения, демонстрирующее разницу в точности между float и double.
    /// </summary>
    public class Lab1 : ILab
    {
        /// <summary>
        /// Запускает выполнение Лабораторной работы 1.
        /// </summary>
        public void Run()
        {
